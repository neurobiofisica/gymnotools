...
class PlotData(QtGui.QDialog):
    ...
    def __init__(self, app, dbf, spikesf, datafile, undoFilename, folder, saturation, winSize, stepSize, parent=None):
        self.app = app
        ...
        self.plotData(0, self.winSize, plotSVM=True) # Creates self.fig and self.ui.graphIPI.canvas.ax.attributes
...
if __name__ == '__main__':
    ...
    parser.add_argument('spikes_file', type=file, help='Location of the file generated by the spikes tool')
    ...
    myapp = PlotData(app, dbf, spikesf, datafile, undoFilename, datafilename, (lowsaturation, highsaturation), winSize, stepSize)
